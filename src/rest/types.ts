...
export const LicenseParamsResponseSchema = z.object({ params: LicenseModuleParamsSchema }).loose();
...
export const TransferUnlockTimeResponseSchema = z.object({ unlock_time: z.string() }).loose();
...
export const IsApprovedMemberResponseSchema = z.object({ is_approved: z.boolean() }).loose();
...
export const MinerParamsResponseSchema = z.object({ params: MinerModuleParamsSchema }).loose();
...
export const ExchangeParamsResponseSchema = z.object({ params: ExchangeParamsSchema }).loose();
