...
export function createMinerApi(context: RestContext): MinerApi {
  return {
    ...
    async getBeacon(epoch) {
      return fetchRest(context, `/ault/miner/v1/beacon/${epoch}`, undefined, BeaconResponseSchema);
    },
    async getParams() {
      return fetchRest(context, "/ault/miner/v1/params", undefined, MinerParamsResponseSchema);
    },
    async getOwnerKey(owner) {
      return fetchRest(context, `/ault/miner/v1/owner/${owner}/key`, undefined, OwnerKeyInfoSchema);
    },
    ...
    async getEpochs(params = {}) {
      ...
      return fetchRest(context, `/ault/miner/v1/epochs${query}`, undefined, EpochsResponseSchema);
    },
    async getEpochsAll() {
