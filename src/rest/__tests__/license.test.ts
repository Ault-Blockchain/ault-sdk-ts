...
describe("LicenseApi", () => {
  ...
  describe("getLicensesByOwner", () => {
    ...
    it("includes pagination params", async () => {
      mockFetch = createMockFetch(mockJsonResponse({ licenses: [], pagination: { next_key: "" } }));
      context.fetchFn = mockFetch;
      api = createLicenseApi(context);
  ...
  describe("getLicensesByOwnerAll", () => {
    ...
    it("throws when pagination cursor repeats", async () => {
      ...
      await expect(api.getLicensesByOwnerAll("ault1owner")).rejects.toThrow(
  ...
  describe("getParams", () => {
    it("fetches module params", async () => {
      mockFetch = createMockFetch(mockJsonResponse({ params: sampleLicenseParams }));
      context.fetchFn = mockFetch;
      api = createLicenseApi(context);
  ...
  describe("getMinters", () => {
    it("fetches minters list", async () => {
      mockFetch = createMockFetch(mockJsonResponse({ minters: ["ault1m1", "ault1m2"] }));
      context.fetchFn = mockFetch;
      api = createLicenseApi(context);
  ...
  describe("getApprovedMembers", () => {
    it("fetches approved members list", async () => {
      mockFetch = createMockFetch(mockJsonResponse({ members: ["ault1member1"] }));
      context.fetchFn = mockFetch;
      api = createLicenseApi(context);
