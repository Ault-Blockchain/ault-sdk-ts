  ...
  encode(message: Validator, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.unbondingHeight !== 0n) {
      if (BigInt.asIntN(64, message.unbondingHeight) !== message.unbondingHeight) {
        throw new globalThis.Error(
          "value provided for field message.unbondingHeight of type int64 too large",
        );
      }
    ...
    if (message.unbondingOnHoldRefCount !== 0n) {
      if (BigInt.asIntN(64, message.unbondingOnHoldRefCount) !== message.unbondingOnHoldRefCount) {
        throw new globalThis.Error(
          "value provided for field message.unbondingOnHoldRefCount of type int64 too large",
        );
      }
    ...
    for (const v of message.unbondingIds) {
      if (BigInt.asUintN(64, v) !== v) {
        throw new globalThis.Error(
          "a value provided in array field unbondingIds of type uint64 is too large",
        );
      }
      writer.uint64(v);
    }
  ...
  encode(
    ...
    if (message.creationHeight !== 0n) {
      if (BigInt.asIntN(64, message.creationHeight) !== message.creationHeight) {
        throw new globalThis.Error(
          "value provided for field message.creationHeight of type int64 too large",
        );
      }
    ...
    if (message.unbondingId !== 0n) {
      if (BigInt.asUintN(64, message.unbondingId) !== message.unbondingId) {
        throw new globalThis.Error(
          "value provided for field message.unbondingId of type uint64 too large",
        );
      }
