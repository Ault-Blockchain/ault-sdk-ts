  ...
  encode(message: RequestInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.blockVersion !== 0n) {
      if (BigInt.asUintN(64, message.blockVersion) !== message.blockVersion) {
        throw new globalThis.Error(
          "value provided for field message.blockVersion of type uint64 too large",
        );
      }
    ...
    if (message.p2pVersion !== 0n) {
      if (BigInt.asUintN(64, message.p2pVersion) !== message.p2pVersion) {
        throw new globalThis.Error(
          "value provided for field message.p2pVersion of type uint64 too large",
        );
      }
  ...
  encode(message: RequestInitChain, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.initialHeight !== 0n) {
      if (BigInt.asIntN(64, message.initialHeight) !== message.initialHeight) {
        throw new globalThis.Error(
          "value provided for field message.initialHeight of type int64 too large",
        );
      }
  ...
  encode(message: RequestQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.height !== 0n) {
      if (BigInt.asIntN(64, message.height) !== message.height) {
        throw new globalThis.Error(
          "value provided for field message.height of type int64 too large",
        );
      }
  ...
  encode(
    ...
    if (message.height !== 0n) {
      if (BigInt.asUintN(64, message.height) !== message.height) {
        throw new globalThis.Error(
          "value provided for field message.height of type uint64 too large",
        );
      }
  ...
  encode(message: RequestPrepareProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.maxTxBytes !== 0n) {
      if (BigInt.asIntN(64, message.maxTxBytes) !== message.maxTxBytes) {
        throw new globalThis.Error(
          "value provided for field message.maxTxBytes of type int64 too large",
        );
      }
  ...
  encode(message: ResponseInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.appVersion !== 0n) {
      if (BigInt.asUintN(64, message.appVersion) !== message.appVersion) {
        throw new globalThis.Error(
          "value provided for field message.appVersion of type uint64 too large",
        );
      }
    ...
    if (message.lastBlockHeight !== 0n) {
      if (BigInt.asIntN(64, message.lastBlockHeight) !== message.lastBlockHeight) {
        throw new globalThis.Error(
          "value provided for field message.lastBlockHeight of type int64 too large",
        );
      }
  ...
  encode(message: ResponseQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.index !== 0n) {
      if (BigInt.asIntN(64, message.index) !== message.index) {
        throw new globalThis.Error(
          "value provided for field message.index of type int64 too large",
        );
      }
  ...
  encode(message: ResponseCheckTx, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.gasWanted !== 0n) {
      if (BigInt.asIntN(64, message.gasWanted) !== message.gasWanted) {
        throw new globalThis.Error(
          "value provided for field message.gasWanted of type int64 too large",
        );
      }
    ...
    if (message.gasUsed !== 0n) {
      if (BigInt.asIntN(64, message.gasUsed) !== message.gasUsed) {
        throw new globalThis.Error(
          "value provided for field message.gasUsed of type int64 too large",
        );
      }
  ...
  encode(message: ResponseCommit, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.retainHeight !== 0n) {
      if (BigInt.asIntN(64, message.retainHeight) !== message.retainHeight) {
        throw new globalThis.Error(
          "value provided for field message.retainHeight of type int64 too large",
        );
      }
  ...
  encode(message: Validator, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.power !== 0n) {
      if (BigInt.asIntN(64, message.power) !== message.power) {
        throw new globalThis.Error(
          "value provided for field message.power of type int64 too large",
        );
      }
  ...
  encode(message: Misbehavior, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.totalVotingPower !== 0n) {
      if (BigInt.asIntN(64, message.totalVotingPower) !== message.totalVotingPower) {
        throw new globalThis.Error(
          "value provided for field message.totalVotingPower of type int64 too large",
        );
      }
