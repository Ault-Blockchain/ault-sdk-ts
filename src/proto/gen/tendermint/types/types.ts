  ...
  encode(message: BlockMeta, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.blockSize !== 0n) {
      if (BigInt.asIntN(64, message.blockSize) !== message.blockSize) {
        throw new globalThis.Error(
          "value provided for field message.blockSize of type int64 too large",
        );
      }
    ...
    if (message.numTxs !== 0n) {
      if (BigInt.asIntN(64, message.numTxs) !== message.numTxs) {
        throw new globalThis.Error(
          "value provided for field message.numTxs of type int64 too large",
        );
      }
  ...
  fromJSON(object: any): BlockMeta {
    return {
      ...
      numTxs: isSet(object.numTxs)
        ? BigInt(object.numTxs)
        : isSet(object.num_txs)
          ? BigInt(object.num_txs)
          : 0n,
    };
  },
