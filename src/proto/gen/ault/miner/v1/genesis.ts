...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.lastSettledEpoch !== 0n) {
      if (BigInt.asUintN(64, message.lastSettledEpoch) !== message.lastSettledEpoch) {
        throw new globalThis.Error(
          "value provided for field message.lastSettledEpoch of type uint64 too large",
        );
      }
    ...
    if (message.epochStartTime !== 0n) {
      if (BigInt.asIntN(64, message.epochStartTime) !== message.epochStartTime) {
        throw new globalThis.Error(
          "value provided for field message.epochStartTime of type int64 too large",
        );
      }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 17: {
          ...
          message.lastDelegationEpochs.push(
            LastDelegationEpochEntry.decode(reader, reader.uint32()),
          );
          continue;
        }
        case 18: {
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.lastDelegationEpochs?.length) {
      obj.lastDelegationEpochs = message.lastDelegationEpochs.map((e) =>
        LastDelegationEpochEntry.toJSON(e),
      );
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.lastSubmitEpochs =
      object.lastSubmitEpochs?.map((e) => LastSubmitEpoch.fromPartial(e)) || [];
    ...
    message.miningDelegations =
      object.miningDelegations?.map((e) => MiningDelegation.fromPartial(e)) || [];
    message.delegationQueue =
      object.delegationQueue?.map((e) => MiningDelegation.fromPartial(e)) || [];
    ...
    message.lastDelegationEpochs =
      object.lastDelegationEpochs?.map((e) => LastDelegationEpochEntry.fromPartial(e)) || [];
    message.signerRateLimits =
      object.signerRateLimits?.map((e) => SignerRateLimitEntry.fromPartial(e)) || [];
    message.carryoverEmission =
      object.carryoverEmission !== undefined && object.carryoverEmission !== null
        ? Coin.fromPartial(object.carryoverEmission)
        : undefined;
    message.allTimeCredits =
      object.allTimeCredits?.map((e) => AllTimeCreditsEntry.fromPartial(e)) || [];
    message.allTimePayouts =
      object.allTimePayouts?.map((e) => AllTimePayoutsEntry.fromPartial(e)) || [];
    return message;
  },
};
  ...
  fromJSON(object: any): EpochWinnersInfo {
    return {
      ...
      winners: globalThis.Array.isArray(object?.winners)
        ? object.winners.map((e: any) => Winner.fromJSON(e))
        : [],
    };
  },
...
export const LastDelegationEpochEntry: MessageFns<LastDelegationEpochEntry> = {
  encode(
    message: LastDelegationEpochEntry,
  ...
  create<I extends Exact<DeepPartial<LastDelegationEpochEntry>, I>>(
    base?: I,
  ): LastDelegationEpochEntry {
    return LastDelegationEpochEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LastDelegationEpochEntry>, I>>(
    object: I,
  ): LastDelegationEpochEntry {
    const message = createBaseLastDelegationEpochEntry();
    message.licenseId = object.licenseId ?? 0n;
...
export const SignerRateLimitEntry: MessageFns<SignerRateLimitEntry> = {
  ...
  fromPartial<I extends Exact<DeepPartial<SignerRateLimitEntry>, I>>(
    object: I,
  ): SignerRateLimitEntry {
    const message = createBaseSignerRateLimitEntry();
    message.epoch = object.epoch ?? 0n;
...
export const AllTimeCreditsEntry: MessageFns<AllTimeCreditsEntry> = {
  encode(message: AllTimeCreditsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.credits !== 0n) {
      if (BigInt.asUintN(64, message.credits) !== message.credits) {
        throw new globalThis.Error(
          "value provided for field message.credits of type uint64 too large",
        );
      }
  ...
  fromPartial<I extends Exact<DeepPartial<AllTimeCreditsEntry>, I>>(
    object: I,
  ): AllTimeCreditsEntry {
    const message = createBaseAllTimeCreditsEntry();
    message.licenseId = object.licenseId ?? 0n;
...
export const AllTimePayoutsEntry: MessageFns<AllTimePayoutsEntry> = {
  ...
  fromPartial<I extends Exact<DeepPartial<AllTimePayoutsEntry>, I>>(
    object: I,
  ): AllTimePayoutsEntry {
    const message = createBaseAllTimePayoutsEntry();
    message.licenseId = object.licenseId ?? 0n;
