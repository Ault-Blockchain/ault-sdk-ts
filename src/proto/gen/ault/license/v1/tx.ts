...
/** MsgSetParams defines a message to update the module parameters */
...
/** MsgSetParamsResponse defines the response for MsgSetParams */
...
export const MsgSetParams: MessageFns<MsgSetParams> = {
  encode(message: MsgSetParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
  ...
  create<I extends Exact<DeepPartial<MsgSetParams>, I>>(base?: I): MsgSetParams {
    return MsgSetParams.fromPartial(base ?? ({} as any));
  },
...
export const MsgSetParamsResponse: MessageFns<MsgSetParamsResponse> = {
  encode(_: MsgSetParamsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgSetParamsResponse>, I>>(base?: I): MsgSetParamsResponse {
    return MsgSetParamsResponse.fromPartial(base ?? ({} as any));
  },
