...
Releases are tag-based and automated with GitHub Actions.
...
The publish workflow runs on tags matching `v*`, validates the package, publishes to npm, and creates a GitHub release.
